...
echo ""
echo "Hệ thống sẽ tự động kiểm tra cập nhật từ GitHub mỗi phút và triển khai khi có cập nhật mới."
...
echo "Thư mục log: $AUTODEPLOY_ROOT/logs/"#!/bin/bash
...
echo "1. Push code lên repository gốc. Hệ thống sẽ tự động kiểm tra mỗi phút và triển khai khi có cập nhật mới."
